    ...
    return (
        <div className="relative bg-gray-50">
            <div className="relative h-[450px] md:h-[600px] flex items-center overflow-hidden">
                ...
                {/* Content */}
                <div className="container-custom relative z-10 flex flex-col items-center justify-center h-full text-center w-full pb-16">
                    <div className="w-full animate-fade-in-up text-white px-4 flex flex-col items-center">
                        <p className="text-base md:text-lg uppercase tracking-[0.4em] font-black text-[#cca86e] mb-4 drop-shadow-md">
                            WELCOME TO FAST ASLEEP
                        </p>
                        
                        <h1 className="font-light leading-[1] mb-5 flex justify-center w-full drop-shadow-lg">
                            <span className="font-script font-normal lowercase text-white text-5xl md:text-6xl lg:text-7xl block mb-2 leading-tight">
                                wake up to a better version of you.
                            </span>
                        </h1>

                        <p className="text-base md:text-lg text-white/95 mb-10 font-medium max-w-xl mx-auto tracking-wide drop-shadow-md">
